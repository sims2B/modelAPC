...
#	system("printf '$type;' >> $target");
	...
	system("timeout --signal=9 600s ./bin/modelIP2 $file >> $target"); 
    }
}
...
#system("echo 'nom_instance;N;M;F;tps;solv;feas;opt;obj;obj1;obj2;obj22;setup;gapCplex;valide' >> $target");
explore $path;
